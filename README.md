...
```clike
// 引入 stdio.h 头文件，stdio 是 Standard Input/Output 的缩写，标准输入输出的意思。
#include <stdio.h>
...
> 上面的 %d 会被替换成整数，如果需要被替换成其他类型，比如小数呢？从书中 "变量与表达式" 一节找找答案，也可以尝试借助 AI 工具，写出代码后运行验证一下。
